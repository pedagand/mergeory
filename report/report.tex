...
If some code is deleted in one of the commits with color $c$, it must also be deleted in the merged result a color $c' \supseteq c$. Moreover, if two commits delete the same code, the result
pushes meta-variables as far as possible down the deleted tree.
