...
\tikzstyle{changenode} = [draw, rectangle]
...
\centering\begin{tikzpicture}
    ...
    \node[varnode, colorIns] (ins_block) at ($(del_plus)+(4.25,0)$) {$\{\ldots\}$};
...
\centering\begin{tikzpicture}
    ...
    \node[changenode, scale=0.8, colorDel] (spine_stmt1) at ($(spine_block)+(-2.5,-1.5)$) {\tikz{
    ...
    \node[changenode, scale=0.8, colorIns] (spine_stmt3) at ($(spine_block)+(2.5,-1.5)$) {\tikz{
    ...
    \node[changenode, scale=0.8] (change_y) at ($(spine_stmt2)+(0.75,-1)$) {\tikz{
