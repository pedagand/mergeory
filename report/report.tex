...
commit and ease fusion later. These notions will be explained in further detail after.
...
Our syntax tree difference structure encodes local tree
modifications, list insertions and deletions and a notion of typed
multi-source, multi-target code moves.

\subsubsection{Grammar for syntax tree differences}
