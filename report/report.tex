...
\date{MPRI internship report - 2020}
...
that produces a predictable syntactic fusion of
...
oracles~\cite{girka2018differential} between the original code and a merged candidate,
...
colors of the expressions, we use the correlation oracle framework \cite{girka2018differential}.
